...
<div class="container-fluid">
  <div class="row" role="tabpanel">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      ...
      <h2 class="page-header"><span class="js-channel-islive islive-indicator small" data-toggle="popover" data-placement="bottom" data-content="Loading..."><i class="fa fa-fw fa-twitch fa-spin text-muted"></i></span><span class="js-channel-title"></span></h2>
