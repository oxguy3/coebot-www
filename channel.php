...
<div class="container-fluid">
  <div class="row" role="tabpanel">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      ...
      <h2 class="page-header"><span class="js-channel-islive islive-indicator text-muted small" data-toggle="tooltip" data-placement="right" title="Loading..."><i class="fa fa-fw fa-twitch fa-spin"></i></span><span class="js-channel-title"></span></h2>
